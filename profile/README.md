...
| [`pact-ax`](https://github.com/neurobloomai/pact-ax) | **A**gent e**x**perience | Agent-to-agent collaboration |
...
New to PACT? Read [`pact`](https://github.com/neurobloomai/pact) first, then pick the layer closest to what you're building.
